...
```{r Creating Stimuli - Concatenating our files, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
```{r Creating Stimuli - Autodetecting Signals, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
\
**Sample 1:** `r sample(1:100, 5)` \
**Sample 2:** `r sample(1:100, 5)` \
**Sample 3:** `r sample(1:100, 5)` \
...
\
`r set.seed(123)` **Sample 1:** `r sample(1:100, 5)` \
`r set.seed(123)` **Sample 2:** `r sample(1:100, 5)` \
`r set.seed(123)` **Sample 3:** `r sample(1:100, 5)` \
...
\
`r set.seed(123)` **Sample 1A:** `r sample(1:100, 5)` : **Sample 1B:** `r sample(1:100, 5)` : **Sample 1C:** `r sample(1:100, 5)`\
`r set.seed(123)` **Sample 2A:** `r sample(1:100, 5)` : **Sample 2B:** `r sample(1:100, 5)` : **Sample 2C:** `r sample(1:100, 5)`\
`r set.seed(123)` **Sample 3A:** `r sample(1:100, 5)` : **Sample 3B:** `r sample(1:100, 5)` : **Sample 3C:** `r sample(1:100, 5)`\
...
```{r Creating Stimuli - Afternoon Stimtrack I, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
```{r Creating Stimuli - Afternoon Stimtrack II, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
[slice](https://dplyr.tidyverse.org/reference/slice.html) should be familiar to you if you've coded in basically any language. For a single vector, e.g. c(1:6) (`r c(1:6)`) we can take slices just by using the [vector index](https://www.r-tutor.com/r-introduction/vector/vector-index) **[]**, which you'll have seen a few places through this code. So, for example with our list of the numbers 1 to 6, we could slice the 2nd to 4th number in the list with "c(1:6)[2:4]" and get `r c(1:6)[2:4]`. Vector indexes are super useful, and can do [all sorts of things](http://www.r-tutor.com/r-introduction/vector/numeric-index-vector). You'll see them everywhere in R code, so make sure you're familiar with them. 
...
```{r Creating Stimuli - Afternoon Stimtrack III, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
AfternoonSongs <- 
...
```{r Creating Stimuli - Afternoon Stimtrack IV, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
#Make sure destination folder is empty
...
```{r Creating Stimuli - Afternoon Stimtrack V, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
```{r Creating Stimuli - Afternoon Stimtrack VI, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
#Song 1
...
```{r Creating Stimuli - Afternoon Stimtrack VII, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
```{r Creating Stimuli - Afternoon Stimtrack VIII, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
AfternoonSongsList %>%
...
```{r Creating Stimuli - The For Loop - Setup, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
...
```{r Creating Stimuli - The For Loop, message= FALSE, warning = FALSE, results = "hide", cache = TRUE}
